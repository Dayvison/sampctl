...
type BuildConfig struct {
	...
	PreBuild   [][]string        `json:"pre_build,omitempty"`  // set of commands to run before the build
	PostBuild  [][]string        `json:"post_build,omitempty"` // set of commands to run after the build
}
